...
class SomeControllerClassWithAVoidMethod{
    @RequestMapping(method = "GET", uri="/test")
...
class SomeControllerClass {
    ...
    @RequestMapping(method = "GET", uri="/test-throwing")
    public String someThrowingMethod(){
        throw new RuntimeException("some exception message");
    }

    @RequestMapping(method = "GET", uri="/test-with-params")
...
class SomeOtherControllerClass {
    @RequestMapping(method = "GET", uri="/otherTest")
